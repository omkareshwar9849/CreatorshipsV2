  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td style="padding-right: 0px;padding-left: 0px;" align="center">
          <h1 style="font-size: 50px; color: white;">Creatorships</h1>
      </td>
    </tr>
  </table>
...
//       pass: "770a7828ab8a4fc872f83e718f8d5ce6-5d2b1caa-31f8f214om",
//     },
//   });
...
const mailPass = process.env.MAIL;
...
router.post("/sendotp", async (req, res) => {
  ...
  try {
    const info = await transporter.sendMail({
      from: '"Creatorships"', // sender address
      to: req.body.email, // list of receivers
      subject: `Creatorships OTP 🤩😇 - ${generatedOtp}`, // Subject line
      text: "Otp is "+generatedOtp, // plain text body
      html: getHtml(generatedOtp), // html body
    });
